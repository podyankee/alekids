	...
	<div class="woocommerce-grouped-product-list group_table">
		<div class="item_holder">
			...
			foreach ( $grouped_products as $grouped_product_child ) {
				...
				echo '<div id="product-' . esc_attr( $grouped_product_child->get_id() ) . '" class="font_one form_wrapper woocommerce-grouped-product-list-item ' . esc_attr( implode( ' ', wc_get_product_class( '', $grouped_product_child ) ) ) . '">';
