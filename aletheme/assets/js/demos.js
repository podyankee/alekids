    ...
    ale_wp_admin_demos = {
        ...
        init: function init() {
            ...
            jQuery().ready(function() {
                ...
                //Builder selector
                //hide all builder install buttons
                jQuery('.builder_plugins_name span.install_but').hide()

                jQuery('.builder_type').each(function(){
                    var checked_id = jQuery(this).attr('id');
                    var checked_name = jQuery(this).attr('name');

                    //show install buttons based on radio button
                    if(jQuery(this).is(':checked')){
                        //Store in cookie selected builder for selected demo
                        document.cookie = "import_"+checked_name+"="+jQuery(this).val();
                ...
                //On Builder Radio Change
                jQuery('.builder_type').on('change',function(){
                    //Hide all builder plugin install links by dafault
                    jQuery('.builder_plugins_name span.install_but').hide()

                    //Display link for selected builder
                    jQuery('.builder_type').each(function(){
                        var checked_id = jQuery(this).attr('id');
                        var checked_name = jQuery(this).attr('name');
